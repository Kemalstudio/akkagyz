...
class ProductController extends Controller
{
    ...
    {
        $product = Product::where('slug', $slug)->marketplace()->with(['category', 'seller', 'images'])
            ->withCount('reviews')
            ->firstOrFail();
        ...
        return view('marketplace.product', compact('product', 'reviews', 'related'));
    }
