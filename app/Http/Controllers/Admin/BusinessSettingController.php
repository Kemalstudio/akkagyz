...
class BusinessSettingController extends Controller
{
    ...
    private function validated(Request $request): array
    {
        return $request->validate([
            'site_name'=>['required','string','max:120'],'tagline'=>['nullable','string','max:180'],'company_name'=>['nullable','string','max:160'],'store_description'=>['nullable','string','max:1200'],'phone'=>['nullable','string','max:40'],'contact_phones'=>['nullable','array','max:10'],'contact_phones.*'=>['nullable','string','max:40','distinct'],'email'=>['nullable','email','max:160'],'address'=>['nullable','string','max:255'],'logo'=>['nullable','image','mimes:png,jpg,jpeg,webp,svg','max:4096'],'currency'=>['required','string','max:10'],'platform_commission_percent'=>['required','numeric','min:0','max:100'],'primary_color'=>['required','regex:/^#[0-9A-Fa-f]{6}$/'],'instagram_url'=>['nullable','url','max:255'],'telegram_url'=>['nullable','url','max:255'],'whatsapp_url'=>['nullable','url','max:255'],'support_hours'=>['nullable','string','max:120'],'google_play_url'=>['nullable','url','max:255'],'app_store_url'=>['nullable','url','max:255'],
