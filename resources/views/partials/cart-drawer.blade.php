...
<aside class="cart-drawer" id="cart-drawer" aria-hidden="true">
    ...
    <div class="cart-drawer-foot"><div class="cart-drawer-total"><span>Итого</span><strong data-cart-subtotal>0 TMT</strong></div><div class="cart-drawer-actions"><a href="{{ route('cart.index') }}" class="btn-ghost">Открыть корзину</a><a href="{{ route('checkout.index') }}" class="btn-accent">Оформить <x-icon name="arrow-right" :size="15"/></a></div></div>
</aside>
